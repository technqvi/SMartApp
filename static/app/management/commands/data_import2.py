...
def importInventoryMaster(filename):
    Product_Type_master(filename)
    Partner_master(filename)
    SLA_master(filename)
    Function_master(filename)
    Brand_master(filename)
    Model_master(filename)
    Serviceteam_master(filename)

def Product_Type_master(filename):
